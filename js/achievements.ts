...
export interface Achievement {id: string; name: string; desc: string; icon: string; special?: boolean; check: (save: Save) => boolean}
...
export function checkAchievements(save: Save) {
